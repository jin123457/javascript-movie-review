...
const changeStarState = (e) => {
  ...
  if (!(target instanceof HTMLInputElement)) {
    target = target.querySelector('input[type="radio"]') ?? ((_a = target.closest("label")) == null ? void 0 : _a.querySelector('input[type="radio"]')) ?? target;
  }
  if (target instanceof HTMLInputElement) {
    const currentRate = Number(target.value) || 0;
    console.log(currentRate);
    const rateStars = (_b = $("#rateForm")) == null ? void 0 : _b.querySelectorAll('input[name="rateInput"]');
    ...
    rateStars == null ? void 0 : rateStars.forEach((star) => {
      ...
      if (parseInt(star.value, 10) <= currentRate) {
        ...
        (_b2 = star.previousElementSibling) == null ? void 0 : _b2.classList.remove("fill-star");
      }
    });
